...
import { Item } from "@/pages/examples/SampleModule";
...
export const ItemModal: React.FC<ItemModalProps> = ({ isOpen, onClose, onSave, item, mode }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>{mode === "create" ? "Add New Item" : mode === "edit" ? "Edit Item" : "View Item"}</DialogTitle>
          <DialogDescription>{mode === "create" ? "Fill in the details to create a new item." : mode === "edit" ? "Update the item details." : "Item details."}</DialogDescription>
        </DialogHeader>
