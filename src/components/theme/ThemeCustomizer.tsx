        ...
        <div className="space-y-4">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="theme">{t("theme.appearance", "Appearance")}</TabsTrigger>
              ...
              <div className="grid grid-cols-3 gap-2">
                {themes.map((item) => (
                  <Button
                    ...
                    className={cn("justify-start w-full", theme === item.name && "border-2 border-primary")}
                  >
            ...
            <TabsContent value="colors" className="pt-4">
              <div className="grid grid-cols-7 gap-2">
                {colorOptions.map((color) => (
                  <button
                    ...
                    className={cn("w-8 h-8 rounded-full flex items-center justify-center border-2", selectedColor === color.value ? "border-primary" : "border-transparent")}
                    style={{
              ...
              <p className="text-xs text-muted-foreground mt-4">{t("theme.colorInfo", "Theme color preferences are saved to your browser.")}</p>
            </TabsContent>
          </Tabs>
        </div>
      </PopoverContent>
