...
import { ArrowRight, CheckCircle, Sparkles, Bell, BellRing, Check, Ban, Info, AlertTriangle, X } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mb-8">Examples of the UI components available in the application.</p>
      </div>
        ...
        <TabsContent value="buttons" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Buttons come in different sizes to fit your layout.</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Combine icons and text for clearer actions.</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-wrap gap-4">
              <Button>
        ...
        <TabsContent value="badges" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Different badge styles for statuses and labels.</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-wrap gap-4">
              <Badge>Default</Badge>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Combine icons and text for richer badges.</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-wrap gap-4">
