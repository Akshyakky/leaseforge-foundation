    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Explore different form components and functionalities
        </p>
      </div>
        ...
        <TabsContent value="basic" className="pt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                A standard form with validation and error handling
              </CardDescription>
            </CardHeader>
            <CardContent>
              <FormBuilder
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button 
                    variant="outline" 
                    onClick={() => notifySuccess('This is a success notification')}
                  >
                    Success
                  </Button>
                  <Button 
                    variant="outline" 
                    onClick={() => notifyError('This is an error notification')}
                  >
                    Error
                  </Button>
                  <Button 
                    variant="outline" 
                    onClick={() => notifyInfo('This is an info notification')}
                  >
                    Info
                  </Button>
                  <Button 
                    variant="outline" 
                    onClick={() => notifyWarning('This is a warning notification')}
                  >
                    Warning
                  </Button>
                </div>
        ...
        <TabsContent value="autosave" className="pt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Form with automatic saving as you type
              </CardDescription>
            </CardHeader>
            <CardContent>
              <AutosaveForm
